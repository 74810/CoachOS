...
class AjustesView extends StatelessWidget {
  ...
  // (Mantenemos _pedirContrasena y _cambiarContrasena iguales que los tenías)
            ...
            children: [
              if (esEntrenador && user != null)
                Container(
                  ...
                  child: Column(
                    children: [
                      const Text("ID DE ENTRENADOR:", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.red)),
                      SelectableText(user.uid, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black)),
                    ],
                  ),
                ),
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () async {
                        ...
                        if (context.mounted) {
                          // MAGIA: Resetea toda la app limpiamente
